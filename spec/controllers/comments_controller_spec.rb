...
RSpec.describe CommentsController, type: :controller do
  ...
  context "guest" do
    ...
    describe "post DELETE destroy" do
      it "redirects the user to the sign in view" do
    ...
    describe "topic DELETE destroy" do
      it "redirects the user to the sign in view" do
  ...
  context "member user doing CRUD on a comment they don't own" do
    ...
    describe "POST comment create" do
      it "increases the number of post comments by 1" do
    ...
    describe "post comment DELETE destroy" do
